...
public class WebhookService {
    ...
    private static final String NAME = "Rahul Machhindra Tapase";
    private static final String REG_NO = "112215187";
    private static final String EMAIL = "112215187@cse.iiitp.ac.in";
    ...
    public void executeOnStartup() {
        ...
        try {
            ...
            String sqlQuery = getSqlQueryBasedOnRegNo(REG_NO);
    ...
    private String getSqlQueryBasedOnRegNo(String regNo) {
        ...
        logger.info("Last two digits of reg number: {}", lastTwoDigits);
        logger.info("Number is {}: {}", (number % 2 == 1 ? "ODD" : "EVEN"), number);
    ...
    // Inner class to hold webhook response
